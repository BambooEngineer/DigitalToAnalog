...
int up = A3; // Potentiometer Middle Pin  + DIODES ARE PLACED ON THIS PIN SO THE ARDUINO IS NOT DAMAGED //
int Vv = A5; // Potentiometer Voltage Pin //
int right = 10; // Potentiometer Middle Pin + DIODES ARE PLACED ON THIS PIN SO THE ARDUINO IS NOT DAMAGED //
